@echo off
REM Railway Deployment Script for Academic Assignment Helper
...
echo Press any key after you've completed the login...
pause
...
echo.
echo Press any key after you've set the environment variables...
pause
